...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Player Warrior = new Player("Warrior", 10, 15);
        System.out.println(Warrior.toString());
        saveObject(Warrior);

        Warrior.setHitPoints(8);
        System.out.println(Warrior);
        Warrior.setWeapon("Stormbringer");
        saveObject(Warrior);
        loadObject(Warrior);
        System.out.println(Warrior);
    ...
    // pass the interface object without specifying actual type
    public static void saveObject(ISavable objectToSave) {
        
        // iterate using .write() method b/c it returns a List
